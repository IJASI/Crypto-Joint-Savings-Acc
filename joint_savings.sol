...
To automate the creation of joint savings accounts, using a Solidity smart contract that accepts two user addresses that are then able to control a joint savings account
